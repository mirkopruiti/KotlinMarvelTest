...
import com.mirkopruiti.kotlinmarveltest.di.AppContext
...
class AppModule(private val application: Application) {
    ...
    fun provideMarvelServiceUrl() = "https://gateway.marvel.com/"
    ...
    fun provideMarvelService(@Named(AppModule.MARVEL_SERVICE_URL) marvelServiceUrl: String,
                             ...
                             converterFactory: GsonConverterFactory): ApiService {
